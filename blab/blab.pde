...
void mouseClicked() {
  if (menu) {
    ...
    if (rect1) {  
      ...
      if (r==0) {   
        audioName = "TS_Red.mp3";
        stihovi = loadStrings("TS_Red.lrc");
      }
      
      else if (r==1) {
        
        audioName = "TS_Bad_blood.mp3";
        stihovi = loadStrings("TS_Bad_blood.lrc");
  
      } 
      else if (r==2) {
  
        audioName = "TS_Blank_space.mp3";
        stihovi = loadStrings("TS_Blank_space.lrc");
      }
      ...
      if (r==0) {   
        audioName = "M_Zitti.mp3";
        stihovi = loadStrings("M_Zitti.lrc");
      }
      
      else if (r==1) {
        
        audioName = "M_Begging.mp3";
        stihovi = loadStrings("M_Begging.lrc");
  
      } 
      else if (r==2) {
  
        audioName = "M_Moriro.mp3";
        stihovi = loadStrings("M_Moriro.lrc");
      }
      ...
      if (r==0) {   
        audioName = "B_Single.mp3";
        stihovi = loadStrings("B_Single.lrc");
      }
      
      else if (r==1) {
        
        audioName = "B_Irreplaceable.mp3";
        stihovi = loadStrings("B_Irreplaceable.lrc");
  
      } 
      else if (r==2) {
  
        audioName = "B_Halo.mp3";
        stihovi = loadStrings("B_Halo.lrc");
      }
      ...
      if (r==0) {   
        audioName = "J_Love.mp3";
        stihovi = loadStrings("J_Love.lrc");
      }
      
      else if (r==1) {
        
        audioName = "J_Ghost.mp3";
        stihovi = loadStrings("J_Ghost.lrc");
  
      } 
      else if (r==2) {
  
        audioName = "J_Sorry.mp3";
        stihovi = loadStrings("J_Sorry.lrc");
      }
